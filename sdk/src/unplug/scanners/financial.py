...
_CRYPTO_PATTERNS: list[tuple[str, re.Pattern[str]]] = list(
    load_compiled_patterns("financial_crypto.yaml")
)
_PAYMENT_PATTERNS: list[tuple[str, re.Pattern[str]]] = list(
    load_compiled_patterns("financial_payment.yaml")
)
